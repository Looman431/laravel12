...
Route::post('/projects/create/store',[CreatorsController::class,'store'])->name('projects.store');
Route::get('/projects/show/{id}',[CreatorsController::class,'show'])->name('projects.show');
